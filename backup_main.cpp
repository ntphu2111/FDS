...
int main(void)
{
	...
	while(1)
	{
		...
		haar_cascade->setMinNeighbors(5);
		haar_cascade->setMinObjectSize(cv::Size(50,50));
		haar_cascade->setMaxObjectSize(cv::Size(100,100));	//cout << "Max size: " << haar_cascade->getMaxObjectSize() << std::endl;
